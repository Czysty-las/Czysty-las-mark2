<div class="optionBelt">
    ...
    <?php if ($_SESSION['calendar']) { ?><a class="option" id="calendar" href="index.php?action=calendar_list"/></a><?php } ?>
...
<div class="optionBelt">
    ...
    <a class="option" id="users" href="index.php?action=users_list"></a>
